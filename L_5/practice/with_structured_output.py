...
class Review(TypedDict):
    key_theams: Annotated[list[str],'Write down all the key theams discussed in the review in a list']
    summary: Annotated[str,'A Brief summary about the review']
    sentiment:Annotated[str,'sentiment about the review Possitive, negative or nutral']
    pros: Annotated[Optional[list[str]],'write show all the rows inside the list']
    cons: Annotated[Optional[list[str]],'write show all the rows inside the list']
